...
public class RunCRON {
	...
	public static void main(String[] args) {
	    ...
	    try {
	        ...
	        input = new FileInputStream("runCRON_config.properties");
		...
		//clicks on IT Support tab
		clickMethod(driver, wait, "//div[@class='tabbable']/ul/li[7]/a");
		
		driver.findElement(By.linkText("Trigger Scheduled Job")).click();
		
		clickMethod(driver, wait, "//input[@value='ReleaseForecast']");

		clickMethod(driver, wait, "//button[@id='okBtn']");

		sleepTime(5000);
		clickMethod(driver, wait, "//button[@id='refreshBtn']");
